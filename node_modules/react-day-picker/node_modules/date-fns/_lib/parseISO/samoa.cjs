...
var _nodeAssert = require("./node:assert"); // This is an edge case DST test for parseISO
...
_nodeAssert.default.strictEqual(
  (0, _index.parseISO)("2011-12-30").getDate(),
  31,
);
_nodeAssert.default.strictEqual(
  (0, _index.parseISO)("2011-12-30T03:30").toString(),
